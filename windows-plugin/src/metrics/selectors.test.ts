...
const snapshot: MetricSnapshot = { type: "metrics", protocol: "streamdeck-monitor", version: 1, timestamp: "2026-01-01T00:00:00Z", data: { cpu: { usagePercent: 42.5, cores: [] }, memory: { usedBytes: 1, availableBytes: 2, usedPercent: 50 }, network: [{ interface: "eth0", rxBytesPerSecond: 2_000_000, txBytesPerSecond: 0, rxBytes: 0, txBytes: 0 }] } };
