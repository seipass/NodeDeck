...
const snapshot: MetricSnapshot = { type: "metrics", protocol: "streamdeck-monitor", version: 1, timestamp: "2026-01-01T00:00:00Z", data: { cpu: { usagePercent: 42.5, cores: [], load1: 1, load5: 2, load15: 3 }, memory: { usedBytes: 1, availableBytes: 2, usedPercent: 50, swapUsedBytes: 3, swapUsedPercent: 4 }, network: [{ interface: "eth0", rxBytesPerSecond: 2_000_000, txBytesPerSecond: 0, rxBytes: 0, txBytes: 0 }], docker: [{ id: "abc", name: "web", state: "running", cpuPercent: 12.5, memoryUsageBytes: 2_000_000, uptimeSeconds: 65 }] } };
