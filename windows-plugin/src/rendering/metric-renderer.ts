export function renderMetric(label: string, value: number, unit: string, state: "connecting" | "online" | "offline" | "authentication-error" | "agent-error" | "metric-unavailable"): string {
